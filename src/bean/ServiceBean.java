 ...
 */
public class ServiceBean implements Serializable, iInitialConfiguration{
	...
	public static void init(String path) throws Exception{
		Model.setBasicConfig(ServiceBean.MODEL_DIR);
		Model.init();
	...
	private static boolean checkWebService(){
		boolean ok = true;
		try{
			Cmpl m = new Cmpl(ServiceBean.CMPL_MODEL);
	...
	public void solve(){
		...
		try{
			m 		= new Cmpl(ServiceBean.CMPL_MODEL);
